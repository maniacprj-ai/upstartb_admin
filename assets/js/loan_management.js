  ...
  if (didConfirm == true) {
    ...
    //  document.getElementById("det4").style.display = "block"
      ...
      ref51.on("value", function (snapshot4) {
        ...
        win.document.write('<table>' + '<tr><td style="padding-left:10px;">' + g_name + '</td><td style="padding-left:10px;">' + name5 + '</td>'  + '<tr>' + '<tr><td style="padding-left:10px;">' + a_date + '</td><td style="padding-left:10px;">' + vdate2 + '</td>'  + '<tr>'+ '<tr><td style="padding-left:10px;">' + g_phone + '</td><td style="padding-left:10px;">' + vphone2 + '</td>'  + '<tr>'+'<tr><td style="padding-left:10px;">' + l_amount + '</td><td style="padding-left:10px;">' + amount2+" tk"  + '</td>'  + '<tr>'+'<tr><td style="padding-left:10px;">' + m_kisti + '</td><td style="padding-left:10px;">' + kisti2+" tk" + '</td>'  + '<tr>'+'<tr><td style="padding-left:10px;">' + t_kisti + '</td><td style="padding-left:10px;">' + month2 + '</td>'  + '<tr>'+'<tr><td style="padding-left:10px;">' + m_interest + '</td><td style="padding-left:10px;">' + m_interest2 + '</td>'  + '<tr>'+'<tr>'+'<tr><td style="padding-left:10px;">' + p_date + '</td><td style="padding-left:10px;">' + p_date2 + '</td>'  + '<tr>'+  '</table>');
        ...
        win.document.write('<table>' + '<tr><td style="padding-left:10px;">' + loan_signature + '</td><td style="padding-left:10px;">' + '<img src="'+sigImage+'" class="nidimg" alt="Paris" id="fron4" height="120" width="120" style="padding:20px">' + '</td>'  + '<tr>' + '<tr><td style="padding-left:10px;">' + loan_signature2 + '</td><td style="padding-left:10px;">' + '<img src="assets/img/deed.jpeg" class="nidimg" alt="Paris" id="fron4" height="100" width="120" style="padding:20px">' + '</td>'  + '<tr>' + '<tr><td style="padding-left:10px;">' + '</td>'  +   '</table>');
